...
class ModernCompactClinicSystem:
    def __init__(self):
        ...
        self.reminder_settings = {
            ...
            "auto_send_whatsapp": True,  # NEW: Enable auto WhatsApp sending
            "whatsapp_delay": 3  # Delay between messages in seconds
        }
        self.sent_reminders = {}  # Track sent reminders
    ...
    def create_sidebar(self):
        ...
        nav_items = [
            ...
            ("🔍 Search", self.show_search_page, "search"),
    ...
    def check_reminder_type(self, appointment, apt_id, time_diff, reminder_type, target_time):
        ...
        if should_send:
            success = self.send_auto_whatsapp_reminder(appointment, reminder_type)
            if success:
    ...
    def create_add_page(self):
        ...
        # WhatsApp Auto-reminder option (prominent)
        ...
        whatsapp_frame.grid(row=row, column=0, columnspan=2, sticky='ew', pady=15)
        ...
        reminder_cb = tk.Checkbutton(
            whatsapp_frame,
            text="✅ Send automatic WhatsApp reminders (3 days, 1 day, morning, 1 hour before)",
        ...
        reminder_cb.pack(anchor='w', padx=10, pady=10, fill='x')
        row += 1
    ...
    def add_appointment(self):
        """Add new appointment with WhatsApp reminder validation - FIXED WITH CLINIC DATE"""
        # Get form data
        ...
        clinic_date = self.form_vars.get('clinic_date', tk.StringVar()).get().strip()  # FIXED: Now properly gets clinic date
        ...
        appointment = {
            ...
            'phone_number': phone1,
            'phone_number2': phone2,  # FIXED: Now properly saves secondary phone
            'clinic_date': clinic_date,  # FIXED: Now properly saves clinic date
    ...
    def setup_keyboard_shortcuts(self):
        ...
        self.root.bind('<Control-f>', lambda e: self.navigate_to(self.show_search_page, "search"))
    ...
    def show_search_page(self):
        """Show search page"""
        self.hide_all_pages()
        self.pages["search"].pack(fill='both', expand=True)
